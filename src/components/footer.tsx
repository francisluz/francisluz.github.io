...
const Footer = () => {
  return (
    <footer className="bg-accent-1 border-t border-accent-2 dark:bg-accent-1-dark dark:border-accent-2-dark">
      <Container>
          ...
          <div className="flex flex-col lg:flex-row justify-end items-center lg:pl-4 lg:w-1/2">
            ...
            <a 
              ...
              {/* <img src="https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/linkedin.svg" 
                alt="linkedin" height="22px" width="22px" className="inline mr-2 fill-current"/>  */}
              <svg role="img" className="fill-current inline-block h-8 w-8" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
