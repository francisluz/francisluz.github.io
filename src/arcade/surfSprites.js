...
// ripple lines running along the face; '-' marks a streak, ' ' none.
// Rows follow the height above the trough, so the lines bend with the wave.
...
// whitewater, two authored blocks cycled at different offsets
export const FOAM = [
  toTile([
...
// the pitching lip: falling sheet with vertical streaks
